...
mapping of incoming action arguments. E.g. an argument can not be mapped or
...
Can be replaced in order to return :php:`false` to prevent generation of a flash
