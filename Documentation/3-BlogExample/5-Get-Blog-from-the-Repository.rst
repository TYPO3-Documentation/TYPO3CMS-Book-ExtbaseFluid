...
.. sidebar:: Excursion: The Repository
   ...
   the cellar, or is not even printed yet. It is only important that you get the
   book.
   Remarks made with a pencil by you will be added permanently when you return
   the book.
