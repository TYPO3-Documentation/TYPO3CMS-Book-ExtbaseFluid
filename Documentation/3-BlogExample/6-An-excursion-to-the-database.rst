...
During the trip to the database, bear in mind that we are in the brush of the
...
value. It does not contain any objects yet, and it also does not contain any data on related posts,
