...
set and/or read only by the methods :methodname:`setProperty()`
and :methodname:`getProperty()` declared as ``public``.
...
The method :methodname:`__construct()` serves to guarantee
