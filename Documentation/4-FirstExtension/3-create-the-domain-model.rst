...
concept of our domain is the "product". All the important properties
...
Below we have a look into this file, note that the class
...
The product properties are designed as class variables :php:`$name`, :php:`$description` and :php:`$quantity` and
...
and :php:`getProperty()`, which are declared as `public`.
...
.. tip::
    ...
    of the processing can be added or changed later on, without the need
...
The method `__construct()` is used to guarantee
a well defined state at the beginning of the object's life cycle. Here
