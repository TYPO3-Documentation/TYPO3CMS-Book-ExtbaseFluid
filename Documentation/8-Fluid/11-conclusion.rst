...
followed by the use of partials and layouts, which help structure
your templates. You have learned about the ``cObject`` ViewHelper
that makes use of TypoScript in Fluid templates possible. Also, you
...
terms. Finally, we have shown how you develop your own ViewHelper.
Finally, we have present all concepts again with the help of an extensive
practical sample - the ``sjr_offers`` extension.

By now, you should have a good overview of the different levels of
...
validating of data, and the security of an extension.
