...
html_theme_options = {
    'github_repository': 'TYPO3-Documentation/TYPO3CMS-Book-ExtbaseFluid',
    'github_branch': 'latest'
}
latex_documents = [(
    'Index',
    't3extbasebook.tex',
    u'Developing TYPO3 Extensions with Extbase and Fluid',
...
html_use_opensearch = 'https://docs.typo3.org/typo3cms/ExtbaseFluidBook/0.0/'
